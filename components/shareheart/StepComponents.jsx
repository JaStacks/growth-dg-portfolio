    ...
    <div className="bg-white dark:bg-zinc-900 rounded-lg border border-zinc-200 dark:border-zinc-900 p-6">
          ...
          <div key={step.number} className="flex items-center flex-1">
            <div className="flex flex-col items-center flex-1">
              ...
              <div className="mt-2 text-xs text-center">
                ...
                <div className="text-zinc-500">{step.description}</div>
              </div>
            </div>
            {step.number < 3 && (
          ...
          {currentStep === 1 && (
            <div>
              ...
              <input
                ...
                className="w-full px-3 py-2 border border-zinc-200 dark:border-zinc-800 rounded-lg bg-white dark:bg-zinc-950"
              />
            </div>
          )}
          {currentStep === 2 && (
      ...
      <div className="flex justify-between mt-6">
        <button
          ...
          className="px-4 py-2 border border-zinc-200 dark:border-zinc-800 rounded-lg disabled:opacity-50 disabled:cursor-not-allowed"
        >
          Back
        </button>
        <button
